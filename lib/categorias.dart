...
class _SearchScreenState extends State<SearchScreen> {
  ...
  final List<Product> products = const [
    Product(name: 'Farmacia y\nSalud', imagePath: 'assets/farmacia2.png'),
    Product(name: 'Belleza', imagePath: 'assets/siencere2.png'),
    Product(name: 'Cuidado \nPersonal', imagePath: 'assets/higiene2.png'),
    Product(name: 'Bebé', imagePath: 'assets/bebe2.png'),
    Product(name: 'Alimentos\ny Bebidas', imagePath: 'assets/snack2.png'),
    Product(name: 'Hogar \ny Otros', imagePath: 'assets/hogar2.png'),
  ];
