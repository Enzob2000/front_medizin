      ...
      body:  Padding(
        ...
        child: ListView(
          children: [SizedBox(height: 20),
            _buildTextField('Nombres y Apellidos:', 'John Ryan Smith Reslers','1'),
            const SizedBox(height: 20),
            _buildTextField('Número de Identidad o Rif.:', 'V-26.000.000','2'),
            const SizedBox(height: 20),
            _buildTextField('Número de Teléfono:', '+58 414-5110022','1'),
            const SizedBox(height: 20),
            _buildTextField('Correo Electrónico:', 'johnsmith@gmail.com','1'),
            const SizedBox(height: 20),
            _buildTextField('País:', 'Venezuela','3'),
            const SizedBox(height: 20),
             _buildTextField('Estado:', 'Sucre','3'),
            const SizedBox(height: 20),
            _buildTextField('Código Postal:', '6584','3'),
        ...
        TextFormField(
          ...
          decoration: InputDecoration(
            ...
            suffixIcon: IconButton(
              icon: (num=='1')?Icon(Icons.edit_outlined, color: Color.fromARGB(255, 114, 109, 109),size: 25,)
              :(num=='2')?
              Icon(Icons.visibility_outlined, color: Color.fromARGB(255, 114, 109, 109),size: 25,)
              :Icon(Icons.edit_outlined, color: Color.fromARGB(255, 227, 227, 227),size: 25,),
